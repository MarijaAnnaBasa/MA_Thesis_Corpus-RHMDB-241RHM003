...
Original file is located at
    https://colab.research.google.com/drive/1ddKStTN2tb6AEmbAs-nIZch1zF3jVgFy
"""
...
path = '/content/drive/MyDrive/MA_Corpus/Kyiv_Ind/Kyiv_Ind_FULL.xlsx'
...
output = '/content/drive/MyDrive/Scraped_Kyiv_FULL'
...
def scraped(url):
    try:
        ...
        title = soup.find('h1', class_='DefaultPostHero_heroTitle__64RVo')
        date = soup.find('time')
        text = (soup.find('div', class_='c-content DefaultPostDetails_content__y5eHh not-featured-post')
            or soup.find('div', class_='c-content DefaultPostDetails_content__y5eHh'))
...
base = '/content/drive/MyDrive/Scraped_Kyiv_FULL'
    ...
    for file in csv_files:
      try:
        ...
        if 'Date' in df.columns:
            cleaned = df[df['Date'].apply(kyiv).between(start_date, end_date)]
